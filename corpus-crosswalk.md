...
> **Status (2026-08-15, post-flip).** This ranking was the *original* backlog. Most
> P1 families below are now **BUILT** — the appendix tables have been reconciled
> (built rows name their archetype; only genuinely-open rows still read `GAP:`).
> The render-free runway that **remains** is narrow: **extended trig identities**
> (compound-/double-angle, reduction, sum-to-product simplify/solve — class-b) and
> **sine & cosine rule** (2D is render-free; 3D needs a figure), plus the small
> **contingency-table** probability read-off. Everything else still open is
> render-gated (function-graph analysis, ogive/box-plot) or class-c (Euclidean
> geometry). The table below is kept for the yield estimates; the ✅/◻ column marks
> current state.

### P1 families (P1 is the high-yield, low-resistance surface)
| family | state | ~marks/P1 | notes |
|---|---|---|---|
| **Calculus** (first-principles, derivative rules, tangent-via-derivative, cubic-graph analysis, optimisation, motion/integration) | ✅ built | ~35 | `derivative_first_principles`, `derivative_rules`, `tangent_line`, `cubic_stationary_points`, `concavity_inflection`, `optimisation_solve`, `motion_calculus`. Cubic *sketch* is render; interpretation parts class-c. |
| **Function-graph analysis** (hyperbola/parabola/exp/log: intercepts, asymptote, range, transformation, inverse) | ◻ render-gated | ~26 | `func_eval`/`func_inverse` are empty stubs; most parts diagram-stem → renderer dependency. The gated frontier. |
| **Sequences & series** (geometric seq, arithmetic/geometric **series** sum-to-n & S∞, quadratic patterns) | ✅ built | ~23 | `arith_series_*`, `geo_series_finite/infinite`, `geo_seq_*`, `quad_seq_*`. |
| **Q1 algebra extensions** (quadratic inequality, surd equation, exponential equation, nonlinear simultaneous) | ✅ built | ~16 | `quadratic_inequality`, `surd_equation`, `exponential_equation`, `nonlinear_simultaneous`, `discriminant_nature`. |
| **Finance: annuities/loans/timelines/effective-rate** | ✅ built | ~14 | `future_value_annuity`, `present_value_annuity`, `nominal_effective`, `compound_periodic`, `depreciation`. |
| **Probability & counting** (counting principle, independence, tree, total-probability, contingency) | ✅ mostly | ~9 | `probability_venn`, `counting_arrangements`, `independent_events`, `tree_probability`. Only **contingency-table** read-off + the class-c *diagram-drawing* remain. |
...
| 1.1.3 | surd equation | 4 | surd_equation | b | extraneous-root check |
| 1.1.4 | quadratic inequality | 4 | quadratic_inequality | b | sign/critical-value |
| 1.2 | simultaneous (linear+rational) | 5 | nonlinear_simultaneous | b | reduces to quadratic |
| 1.3 | exponential equation | 4 | exponential_equation | b | equate integer exponents |
| 2.1.1 | AP nth-term | 3 | arithmetic_sequence | a | find-term |
| 2.1.2 | AP series sum | 2 | arith/geo_series | b | S_n |
| 2.1.3 | AP find-n | 3 | arithmetic_sequence | a | find-n |
| 2.2.1–3 | quadratic pattern | 8 | RESISTANT | c | "show that" ×3 |
| 3.1.1 | geometric nth-term | 1 | geo_seq | b | write-down |
| 3.1.2 | geometric sigma-sum | 4 | arith/geo_series | b | Σ, solve k |
| 3.2 | geo S∞ + arith sum | 5 | geo_series | b | |
| 4.1–4.2 | exp graph asymptote/x-int | 3 | GAP:exponential-function | b | |
| 4.3 | line through 2 pts | 3 | line_equation | b | |
...
| 5.7 | tangent to hyperbola | 4 | tangent_line | b | |
| 6.1.1 | compound, solve rate | 3 | finance | b | monthly reverse-compound |
| 6.1.2 | effective rate | 2 | nominal_effective | b | |
| 6.2.1 | straight-line depreciation | 2 | finance | b | |
| 6.2.2–6.3 | annuities (FV/PV) | 9 | fv/pv_annuity | b | |
| 7.1 | first principles | 5 | derivative_first_principles | b | |
| 7.2.1–7.2.2 | derivative rules | 5 | derivative_rules | b | |
| 7.3 | derivative sign | 3 | concavity_inflection | b | |
| 8.1 | cubic turning points | 4 | cubic_stationary_points (sketch=render) | b | |
| 8.2–8.3 | sketch / k for 3 roots | 6 | RESISTANT | c | draw / graph-interpret |
| 8.4 | tangent at inflection | 6 | tangent_line | b | |
| 8.5 | inclination angle | 2 | inclination_angle | b | |
| 9.1 | optimisation setup | 3 | RESISTANT | c | "show that A(x)=…" |
| 9.2 | optimisation minimise | 3 | optimisation_solve | b | |
...
| q_id | topic | marks | archetype | class | note |
|---|---|---|---|---|---|
| 1.1–1.3 | regression/correlation | 6 | regression_line | b | |
| 1.4 | interpret r | 1 | RESISTANT | c | |
| 1.5.1–3 | mean / std-dev / threshold | 5 | mean_stddev, mean_stddev | b | positional-only archetype |
| 2.1 | cumulative frequency | 2 | statistics_grouped | b | |
| 2.2–2.3 | total / count | 2 | statistics_grouped | a | |
| 2.4 | find k from est. mean | 4 | grouped_mean_solve | b | |
| 3.1–3.2 | length / gradient | 4 | analytic_geometry_triangle | a | |
| 3.3 | inclination θ | 2 | inclination_angle | b | |
| 3.4 | angle between lines | 3 | angle_between_lines | b | |
| 3.5 | line ∥ SN | 3 | line_equation | b | |
| 3.6 | area ΔLSN | 3 | analytic_geometry_triangle | a | |
| 3.7 | equidistant point | 3 | circumcentre | b | |
| 3.8 | angle LP̂S | 2 | angle_between_lines | b | |
| 4.1 | show p=4 | 2 | RESISTANT | c | |
| 4.2–4.6 | circle: F/tangent/t/eqn/tangency | 18 | circle_equation/tangent | b | 20-mark clean block |
...
| 1.1.3 | quadratic inequality | 4 | quadratic_inequality | b | |
| 1.1.4 | exponential quadratic | 5 | exponent_laws | b | k=2^x substitution |
| 1.1.5 | surd equation | 4 | surd_equation | b | |
| 1.2 | nonlinear simultaneous | 5 | nonlinear_simultaneous | b | |
| 1.3 | telescoping/integer reasoning | 3 | RESISTANT | c | |
| 2.1.1–2.1.2 | AP series sum / sigma | 6 | arith/geo_series, arith_series_sigma | b | |
| 2.2.1–2.2.2 | quadratic pattern | 8 | quad_seq | b | |
| 3.1–3.3 | geometric seq/series | 10 | geo_seq, geo_series | b | |
...
| 6.3 | max vertical distance | 4 | optimisation_solve | b | |
| 6.4 | tangent condition | 5 | GAP:tangent-discriminant | b | |
| 7.1 | compound (quarterly) | 3 | finance | b | |
| 7.2 | straight-line depreciation | 2 | depreciation | b | |
| 7.3.1–7.3.2 | loan/annuity | 9 | present_value_annuity | b | |
| 8.1.1–8.1.2 | derivative rules | 6 | derivative_rules | b | |
| 8.2 | tangent via derivative | 3 | tangent_line | b | |
| 8.3.1 | first principles | 5 | derivative_first_principles | b | |
...
| 10.1 | motion max speed | 3 | motion_calculus | b | |
| 10.2 | motion distance (integrate) | 5 | motion_calculus | b | |
...
| 3.2 | equation of line DC | 2 | line_equation | b | |
...
| 3.7 | coords of A | 6 | line_equation | b | |
...
| 1.1.4 | quadratic inequality | 3 | quadratic_inequality | b | |
| 1.1.5 | surd equation | 4 | surd_equation | b | |
| 1.2 | nonlinear simultaneous (word) | 6 | nonlinear_simultaneous | b | |
| 1.3 | exponent algebra proof | 3 | RESISTANT | c | |
| 2.1.1–2.1.2 | AP general term / find-n | 4 | arithmetic_sequence | a | |
| 2.1.3 | arithmetic series sum | 3 | arith_series_sum | b | |
| 2.2.1–2.2.4 | geometric seq/series | 11 | geo_seq, geo_series | b | |
| 3.1 | quadratic seq gen term | 3 | RESISTANT | c | "show that" |
| 3.2–3.3 | quadratic sequence | 6 | quad_seq | b | |
| 4.1, 4.3, 4.4 | hyperbola graph | 8 | GAP:hyperbola-graph | b | |
| 4.2 | hyperbola y-intercept | 2 | func_eval | a | |
| 4.5 | closest-point optimisation | 3 | optimisation_solve | b | |
| 4.6 | function transformation | 2 | GAP:function-transformation | b | |
| 5.1 | parabola from TP+pt | 3 | RESISTANT | c | "show that" |
| 5.2 | discriminant (no roots) | 2 | discriminant_nature | b | |
...
| 7.1 | effective interest rate | 2 | nominal_effective | b | |
| 7.2–7.3 | annuities / timeline | 11 | fv/pv_annuity, present_value_annuity | b | |
| 8.1 | first principles | 5 | derivative_first_principles | b | |
| 8.2.1–8.2.2 | derivative rules | 6 | derivative_rules | b | |
| 8.3 | common tangent | 6 | tangent_line | b | |
| 9.1 | cubic factor form | 2 | RESISTANT | c | "show that" |
| 9.2–9.5 | cubic TP/concavity/sketch/max | 16 | cubic_stationary_points/concavity (sketch=render), optimisation_solve | b | 9.4 sketch=render |
| 10.1 | probability addition rule | 2 | probability_venn | a | |
| 10.2 | compound probability (word) | 6 | tree_probability | b | |
| 11.1–11.2 | counting principle | 7 | counting_arrangements | b | |
...
| 2.1–2.4 | regression / scatter / predict | 9 | regression_line | b | |
| 2.5 | explain y-intercept | 1 | RESISTANT | c | |
| 3.1 | R = x-intercept of line | 2 | line_equation | b | |
| 3.2–3.3 | length RT / solve m | 7 | analytic_geometry_triangle | b | |
| 3.4 | eqn VR ⊥ ST | 5 | line_equation | b | |
...
| 1.1.2 | quadratic (formula) | 4 | quadratic_roots | a | |
| 1.1.3 | quadratic inequality | 4 | quadratic_inequality | b | |
| 1.1.4 | exponential eqn → quadratic | 4 | exponential_equation | b | |
| 1.1.5 | surd/radical equation | 5 | surd_equation | b | |
| 1.2 | nonlinear simultaneous (word) | 6 | nonlinear_simultaneous | b | |
| 2.1.1 | geometric series (show) | 3 | RESISTANT | c | |
| 2.1.2–2.1.3 | geometric nth/S∞ | 5 | geo_seq, geo_series_infinite | b | |
| 2.2.1 | AP term difference | 2 | arithmetic_sequence | a | |
| 2.2.2 | series sum-to-n, solve k | 5 | arith_series_find_n | b | |
| 3.1, 3.3, 3.4 | quadratic pattern | 7 | quad_seq | b | |
...
| 5.6, 6.4 | tangent (derivative) | 5 | tangent_line | b | |
...
| 7.2 | future-value annuity | 4 | future_value_annuity | b | |
| 7.3.1–7.3.2 | loan repayment | 9 | present_value_annuity | b | |
| 8.1 | first principles | 4 | derivative_first_principles | b | |
| 8.2.1–8.2.2 | derivative rules | 6 | derivative_rules | b | |
| 9.1–9.2, 9.4 | cubic graph | 13 | cubic_stationary_points (sketch=render) | b | |
| 9.3 | f·f′<0 from graph | 4 | RESISTANT | c | |
| 10.1 | show volume eqn | 3 | RESISTANT | c | |
| 10.2 | optimise volume | 3 | optimisation_solve | b | |
| 11.1.1 | independence (show) | 3 | RESISTANT | c | |
| 11.1.2 | two-way table probability | 3 | GAP:contingency-table | b | |
| 11.2 | total probability (word) | 4 | tree_probability | b | |
| 11.3.1–11.3.2 | counting | 6 | counting_arrangements | b | |
...
| q_id | topic | marks | archetype | class | note |
|---|---|---|---|---|---|
| 1.1–1.3, 1.5 | least-squares line / predict / r / gradient-rate | 7 | regression_line | b | |
| 1.4 | interpret r | 1 | RESISTANT | c | |
...
| 3.3–3.4, 3.6 | inclination / line eqn / perp-foot | 7 | line_equation | b | |
| 3.5 | parallelogram 4th vertex | 3 | analytic_geometry_triangle | b | |
| 3.7 | triangle area | 4 | analytic_geometry_triangle | a | |
| 4.1, 4.3–4.8 | circle geometry (analytic) | 17 | circle_equation/tangent | b | 21-mark block |

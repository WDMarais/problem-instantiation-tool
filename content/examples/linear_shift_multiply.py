#!/usr/bin/env python3
"""
Acquisition sheet: x/a ± b = 0 (shift then multiply).

Prerequisites: linear_balance.py (x±a=0), linear_multiply.py (x/a=b).
...
from content.generators.linear_shift_multiply import make_sheet
from content.renderers.a4 import build_html

if __name__ == "__main__":
    ap = argparse.ArgumentParser(
        description="Generate x/a±b=0 shift-then-multiply sheet."
    )
    ap.add_argument("--output", default="linear_shift_multiply.html")
